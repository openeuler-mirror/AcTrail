...
use super::X86_64BoringSslSymbolProbeDetectorConfig;

pub(crate) struct X86_64BoringSslSymbolProbeDetector {
    evidence: BoringSslSymbolEvidence,
}

impl X86_64BoringSslSymbolProbeDetector {
    pub(crate) fn try_new(
        config: X86_64BoringSslSymbolProbeDetectorConfig,
