...
use super::CommonStatePair2732ProbeDetectorConfig;
...
pub(crate) struct CommonStatePair2732ProbeDetector;

impl CommonStatePair2732ProbeDetector {
    pub(crate) fn try_new(
        config: CommonStatePair2732ProbeDetectorConfig,
    ...
    pub(crate) fn into_pattern_pair(self) -> PatternPairProbeDetector {
        PatternPairProbeDetector::new(
            "x86_64-rustls-common-state-pair-27-32",
            "x86_64",
            [
                StaticPatternSpec {
