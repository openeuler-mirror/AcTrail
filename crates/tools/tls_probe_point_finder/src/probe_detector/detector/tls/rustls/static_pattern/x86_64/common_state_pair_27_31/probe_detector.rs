...
use super::CommonStatePair2731ProbeDetectorConfig;
...
const TAKE_PATTERN: &[u8] = &[
    0x41, 0x57, 0x41, 0x56, 0x41, 0x55, 0x41, 0x54, 0x53, 0xc6, 0x87, 0x2e, 0x03, 0x00, 0x00, 0x20,
    0x4c, 0x8b, 0x26, 0x4c, 0x8b, 0x76, 0x08, 0x48, 0x8b, 0x5e, 0x10, 0x49, 0x83, 0xfc, 0xff,
];

pub(crate) struct CommonStatePair2731ProbeDetector;

impl CommonStatePair2731ProbeDetector {
    pub(crate) fn try_new(
        config: CommonStatePair2731ProbeDetectorConfig,
    ...
    pub(crate) fn into_pattern_pair(self) -> PatternPairProbeDetector {
        PatternPairProbeDetector::new(
            "x86_64-rustls-common-state-pair-27-31",
            "x86_64",
            [
                StaticPatternSpec {
                ...
                StaticPatternSpec {
                    pattern_id: "x86_64-rustls-common-state-take-received-plaintext-entry-31",
