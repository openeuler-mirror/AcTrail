...
#define TLS_PROBE_RUSTLS_BORROWED_TAG_SIGNED_MIN 0x8000000000000000ULL
#define TLS_PROBE_RUSTLS_BORROWED_TAG_UNSIGNED_MAX 0xffffffffffffffffULL

enum tls_probe_provider {
    TLS_PROBE_PROVIDER_OPENSSL = 1,
    TLS_PROBE_PROVIDER_BORINGSSL = 2,
    TLS_PROBE_PROVIDER_RUSTLS = 3,
    TLS_PROBE_PROVIDER_GNUTLS = 5,
    TLS_PROBE_PROVIDER_NSS = 6,
};
...
enum tls_probe_symbol {
    ...
    TLS_PROBE_SYMBOL_GNUTLS_RECORD_SEND = 7,
    TLS_PROBE_SYMBOL_GNUTLS_RECORD_RECV = 8,
    TLS_PROBE_SYMBOL_NSPR_PR_WRITE = 9,
    TLS_PROBE_SYMBOL_NSPR_PR_SEND = 10,
    TLS_PROBE_SYMBOL_NSPR_PR_READ = 11,
    TLS_PROBE_SYMBOL_NSPR_PR_RECV = 12,
};
