...
use values::{
    ...
    required_enforcement_seccomp_syscalls, required_memlock_rlimit, required_octal_u32,
    required_path, required_payload_redaction_policy, required_payload_socket_capture_backend,
    required_payload_socket_seccomp_syscalls, required_payload_stdio_storage_mode,
    ...
    match command.as_str() {
        ...
        "verify-live" => Ok(ProbeCommand::VerifyLive(LiveVerificationConfig {
            ...
            enforcement: EnforcementConfig {
                ...
                seccomp_syscalls: required_enforcement_seccomp_syscalls(
                    &flags,
                    "--enforcement-seccomp-syscalls",
                )?,
                seccomp_path_max_bytes: required_u32(
                    &flags,
                    "--enforcement-seccomp-path-max-bytes",
                )?,
            },
