...
mod tests {
    ...
    #[test]
    fn trace_list_reply_round_trips() {
        let mut tags = BTreeSet::new();
        tags.insert("batch".to_string());
        let reply = Ok(ControlReply::TraceList(vec![TraceListItem {
