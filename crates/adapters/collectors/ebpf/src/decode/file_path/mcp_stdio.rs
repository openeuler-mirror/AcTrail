//! MCP stdio endpoint, holder and bundle state.
//!
//! This state exists only for effective MCP stdio consumers. Basic IPC
//! observations use kernel FD classification independently.
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub(super) struct McpStdioTracker {
    enabled: bool,
    config: IpcLineageConfig,
...
impl Default for McpStdioTracker {
    fn default() -> Self {
