...
enum actrail_proc_event_kind {
    ...
    ACTRAIL_PROC_EXEC_ATTEMPT = 5,
    ACTRAIL_PROC_EXEC_RESULT = 6,
    ACTRAIL_PROC_FORK_ATTEMPT = 7,
    ACTRAIL_PROC_FORK_RESULT = 8,
    ACTRAIL_PROC_EXEC_ARG = 9,
