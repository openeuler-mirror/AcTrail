...
enum actrail_event_transport_scratch {
    ACTRAIL_EVENT_TRANSPORT_SCRATCH_BYTES = 16384,
};
...
enum actrail_event_transport_diagnostic_counter {
    ...
    ACTRAIL_SOCKET_READ_USER_FAIL = 10,
    ACTRAIL_SOCKET_RESERVE_FAIL = 11,
    ACTRAIL_FILE_PENDING_UPDATE_FAIL = 12,
    ACTRAIL_EVENT_TRANSPORT_DIAG_COUNTER_COUNT = 13,
};
