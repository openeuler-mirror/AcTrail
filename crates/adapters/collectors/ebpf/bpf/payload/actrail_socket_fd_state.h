#ifndef ACTRAIL_SOCKET_FD_STATE_H
#define ACTRAIL_SOCKET_FD_STATE_H
...
static __always_inline void socket_payload_set_fd_state(
    __u32 pid,
    __u32 fd,
    __u32 generation,
    __u32 flags
    ...
    state.flags = flags;
    bpf_map_update_elem(&payload_socket_fds, &key, &state, BPF_ANY);
}
