...
pub(in crate::llm_pipeline) struct ParsedLlmRequest {
    pub(in crate::llm_pipeline) classifier_id: &'static str,
    pub(in crate::llm_pipeline) protocol_id: Option<&'static str>,
    pub(in crate::llm_pipeline) model: Option<String>,
}

pub(in crate::llm_pipeline) trait LlmRequestParser: Send + Sync {
...
pub(in crate::llm_pipeline) fn parse_json_request(
