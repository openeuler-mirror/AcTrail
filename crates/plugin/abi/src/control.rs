pub mod context {
    ...
    pub const CURRENT_NETWORK_ACTION: &str = "c";
}
...
pub mod query {
    ...
    pub const NETWORK_ACTION_CONTEXT: &str = "network-action.v1";
}
...
pub mod network_policy {
    ...
    pub mod grant {
        pub const CURRENT_CONTEXT_QUERY: &str = "network-action.current-context-query";
        pub const RULES_READ: &str = "network-policy.rules.read";
        pub const RULES_MATCH_DRY_RUN: &str = "network-policy.rules.match-dry-run";
        pub const RULES_VALIDATE: &str = "network-policy.rules.validate";
        pub const RULES_APPLY: &str = "network-policy.rules.apply";
    }
}
