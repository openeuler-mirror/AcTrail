...
use config_core::daemon::{
    ...
    HandObservationConfig, IdleDetectionConfig, NetworkControlConfig, PayloadConfig,
    PluginAlertRuntimeConfig, ProcessSeccompConfig, ResourceMetricsConfig, SandboxAlertsConfig,
