...
const TRANSPORT_MESSAGE_KINDS = new Set([MCP_STDIN_KIND, MCP_STDOUT_KIND]);
const REQUEST_KINDS = new Set([MCP_REQUEST_KIND, MCP_STDOUT_KIND]);
const RESPONSE_KINDS = new Set([MCP_RESPONSE_KIND, MCP_STDIN_KIND]);
