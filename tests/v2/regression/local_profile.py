...
_ALLOWED_ENVIRONMENT = {
    ...
    "EXECUTION_ISOLATION_E2E_ARTIFACT_MANIFEST",
    "EXECUTION_ISOLATION_E2E_BACKEND",
    "EXECUTION_ISOLATION_E2E_CTR_RUNTIME",
    "EXECUTION_ISOLATION_E2E_DAEMON_PORT",
    "EXECUTION_ISOLATION_E2E_IMAGE",
    "EXECUTION_ISOLATION_E2E_IMAGE_ARCHIVE",
    "EXECUTION_ISOLATION_E2E_IMAGE_PULL_POLICY",
    "EXECUTION_ISOLATION_E2E_RUNTIME_CONFIG",
    "EXECUTION_ISOLATION_E2E_RUNTIME_TIMEOUT_SECONDS",
    "EXECUTION_ISOLATION_E2E_READY_TIMEOUT_SECONDS",
    "EXECUTION_ISOLATION_E2E_ROOT_DISCOVERY_SETTLE_SECONDS",
    "EXECUTION_ISOLATION_E2E_VM_ROOT",
    "EXECUTION_ISOLATION_E2E_VSOCK_PORT",
    "EXECUTION_ISOLATION_E2E_WORKLOAD_UID",
    "EXECUTION_ISOLATION_E2E_WORKLOAD_GID",
    "EXECUTION_ISOLATION_E2E_XIAOO_BINARY",
}
