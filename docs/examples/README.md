...
Use [08.full-monitor-validation](08.full-monitor-validation/README.md) for real
agent end-to-end validation with `actrailctl launch`, semantic actions, payloads,
OTEL export, and `actrailweb`.
