...
- [端到端时序](end-to-end-sequence.md)：Firecracker 主线及 StratoVirt/native AF_VSOCK、Cloud Hypervisor 可选路径中的进程启动、双层连接注册、Guest 采集、即时批量发送、插件/独立数据库路由、告警、静默 Heartbeat、重连与 fail-local 行为。
